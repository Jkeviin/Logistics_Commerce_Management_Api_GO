...
const docTemplate = `{
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.EmployeePatchAttributes"
                        }
                    }
                ],
                "responses": {
        ...
        "/products": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Código del producto ya existente",
                        "schema": {
                            "$ref": "#/definitions/domain.ErrorResponse"
                        }
                    },
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/domain.SectionPatchAttributes"
                        }
                    },
                    "404": {
                        "description": "La sección no existe",
    ...
    "definitions": {
        ...
        "domain.EmployeePatchAttributes": {
            "type": "object",
            "properties": {
                "card_number_id": {
                    "type": "integer"
