...
type EmployeeService interface {
	...
	Update(id int64, employee domain.EmployeeAttributes) (domain.Employee, error)
	ReportInboundOrdersByEmployee(idEmployee int64) ([]domain.EmployeeWithInboundOrdersCount, error)
}
