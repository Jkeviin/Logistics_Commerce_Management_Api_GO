...
type SectionRepository interface {
	...
	// Reports functions for sections with products
	ReportProductBySectionById(idSection int64) (domain.SectionWithProductCount, error)
	ReportProductBySection() ([]domain.SectionWithProductCount, error)
}
