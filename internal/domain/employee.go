...
type EmployeeWithInboundOrdersCount struct {
	ID                 int64  `json:"id"`
	CardNumber         int64  `json:"card_number_id"`
	FirstName          string `json:"first_name"`
	LastName           string `json:"last_name"`
...
type EmployeeWithInboundOrdersCountResponse struct {
	Data []EmployeeWithInboundOrdersCount `json:"data"`
}
