...
type ProductAttributesPatch struct {
	...
	RecommendedFreezingTemperature *int       `json:"recommended_freezing_temperature"`
...
type ProductAttributes struct {
	...
	Width                          int       `json:"width" valid:"required~El ancho es obligatorio"`
	Height                         int       `json:"height" valid:"required~La altura es obligatoria"`
	Length                         int       `json:"length" valid:"required~La longitud es obligatoria"`
	NetWeight                      int       `json:"netweight" valid:"required~El peso neto es obligatorio"`
	ExpirationRate                 int       `json:"expiration_rate" valid:"required~La tasa de caducidad es obligatoria"`
	RecommendedFreezingTemperature int       `json:"recommended_freezing_temperature" valid:"required~La temperatura de congelación recomendada es obligatoria"`
	FreezingRate                   int       `json:"freezing_rate" valid:"required~La tasa de congelación es obligatoria"`
